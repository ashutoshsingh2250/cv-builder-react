...
const Resume = forwardRef(({ information, sections, activeColor, templateStyleOption, ...props }, ref) => {
    ...
    const sectionDivItalic = {
        [sections.workExp]: (
            <div
                ...
                className={`${styles.section} ${info.workExp?.sectionTitle ? "" : styles.hidden}`}
            >
                <div className={styles.sectionTitle}><i>{info.workExp.sectionTitle}</i></div>
                <div className={styles.content}>
                    {info.workExp?.details?.map((item) => (
                        <div className={styles.item} key={item.title}>
                            {item.title ? (
        ...
        [sections.project]: (
            <div
                ...
                className={`${styles.section} ${info.project?.sectionTitle ? "" : styles.hidden}`}
            >
                <div className={styles.sectionTitle}><i>{info.project.sectionTitle}</i></div>
                <div className={styles.content}>
                    {info.project?.details?.map((item) => (
                        <div className={styles.item}>
                            {item.title ? (
        ...
        [sections.education]: (
            ...
            >
                <div className={styles.sectionTitle}>
                    <i>{info.education?.sectionTitle}</i>
                </div>
                <div className={styles.content}>
                    {info.education?.details?.map((item) => (
                        <div className={styles.item}>
        ...
        [sections.achievement]: (
            ...
            >
                <div className={styles.sectionTitle}>
                    <i>{info.achievement?.sectionTitle}</i>
                </div>
                <div className={styles.content}>
                    {info.achievement?.points?.length > 0 ? (
                        <ul className={styles.numbered}>
        ...
        [sections.summary]: (
            <div
                ...
                className={`${styles.section} ${info.summary?.sectionTitle ? "" : styles.hidden}`}
            >
                <div className={styles.sectionTitle}><i>{info.summary?.sectionTitle}</i></div>
                <div className={styles.content}>
                    <p className={styles.overview}>{info.summary?.detail}</p>
                </div>
            </div>
        ...
        [sections.other]: (
            <div
                ...
                className={`${styles.section} ${info.other?.sectionTitle ? "" : styles.hidden}`}
            >
                <div className={styles.sectionTitle}><i>{info.other?.sectionTitle}</i></div>
                <div className={styles.content}>
                    <p className={styles.overview}>{info?.other?.detail}</p>
                </div>
            </div>
            ...
            <div ref={containerRef} className={styles.container}>
                ...
                <div className={styles.main}>
                    <div className={styles.col1}>
                        {templateStyleOption == 0 &&
                            columns[0].map((item) =>
                                sectionDivNormal[item]
                            )
                        }
                        {templateStyleOption == 1 &&
                            columns[0].map((item) =>
                                sectionDivItalic[item]
                            )
                        }
                    </div>
